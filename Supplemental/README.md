...
3.  Explore the visualization using the dropdown list on the dashboard.
  ...
  a.  For example, when you select a sample using the dropdownlist, you are able to view 
      -  sample metadata, i.e., an individual's demographic information. ![hw](Images/hw03.png)
      -  the top 10 OTUs found in that individual on a horizontal bar  ![bar Chart](Images/hw01.png)
      -  a bubble chart that displays each sample ![Bubble Chart](Images/bubble_chart.png)
